...
var projectInfo = [
	{
		"projectImg": ["http://res.cloudinary.com/da4mca3no/image/upload/v1494371094/limeRock_hfecdh.png", "http://res.cloudinary.com/da4mca3no/image/upload/v1494371091/login_ympoel.png", 'http://res.cloudinary.com/da4mca3no/image/upload/v1494371094/welcome_bx4ipb.png', 'Assets/nav.png', 'http://res.cloudinary.com/da4mca3no/image/upload/v1494371093/stock_fasza9.png', 'http://res.cloudinary.com/da4mca3no/image/upload/v1494371092/news_wkzons.png', 'http://res.cloudinary.com/da4mca3no/image/upload/v1494371089/history_yifybx.png'],
	...
	{
		"projectImg": ["http://res.cloudinary.com/da4mca3no/image/upload/v1494371089/digitalPortfolio_mhymjw.png"],
	...
	{
		"projectImg": ["http://res.cloudinary.com/da4mca3no/image/upload/v1494371093/legislationWatch_agbjlm.png", "http://res.cloudinary.com/da4mca3no/image/upload/v1494371095/legislationWatch2_lba7kn.png", "http://res.cloudinary.com/da4mca3no/image/upload/v1494371090/legislationWatch3_l2jdma.png", "http://res.cloudinary.com/da4mca3no/image/upload/v1494371092/legislationWatch4_zgznvi.png", "Assets/legislationWatch5.png"],
	...
	{
		"projectImg": ["http://res.cloudinary.com/da4mca3no/image/upload/v1494371091/Llama_sdo97o.png"] ,
		"projectTitle": "Llama",
